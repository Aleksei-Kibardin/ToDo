<template>
  <div
    class="background-window flex relative justify-center min-h-[100vh] h-full w-full bg-gradient-to-r from-blue-200 to-blue-500 dark:from-[#071734] dark:to-[#00001b] animate-gradient">
